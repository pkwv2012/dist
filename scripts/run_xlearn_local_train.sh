...
echo "=====================================BigDataLR================================="
../build/xlearn_train ~/Documents/xlearn/demo/classification/criteo_ctr/small_train.txt -v ~/Documents/xlearn/demo/classification/criteo_ctr/small_train.txt -s 0 -x auc --dis-es -p ftrl -alpha 5e-2 -beta 1.0 -lambda_1 5e-5 -lambda_2 15.0 --no-norm
#echo "=====================================BigDataFM================================="
